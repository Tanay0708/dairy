...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font " id="contact-us">
    <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900" href="/">
       <img src={dairyLogo} alt="" className="w-38 h-32 text-white p-2 " />
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
     
        {/* <span className="ml-3 text-xl text-coral-red">Madhushree</span> */}
      </a>
