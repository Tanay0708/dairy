...
const FooterM = () => {
  return (
    ...
    <div className='rounded-lg  w-[95%] m-auto max-sm:h-[415px] hidden max-sm:block relative bg-[#F2D913] mb-5'>
        ...
        <p className='absolute bottom-36  ml-5 w-[345px] text-balance font-[500]'>
        We have a vision of setting a new benchmark in the milk industry with superior quality dairy products, a sustainable ecosystem and a thriving relation with our farmers.
        </p>
